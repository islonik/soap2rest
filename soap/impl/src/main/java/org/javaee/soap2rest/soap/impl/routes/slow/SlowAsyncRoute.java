 ...
 */
public class SlowAsyncRoute extends RouteBuilder {

    private static final String ASYNC_ROUTE_NAME = RouteServices.valueOf(ServiceType.SLOW, RouteServices.ASYNC);
    ...
    public void configure() {
        ...
        from(ASYNC_ROUTE_NAME)
                ...
                .bean(asyncLogic, SlowLogic.METHOD);
    }
